...
**Repository:** [laundromatai-showcase](https://github.com/seansabado/laundromatai-showcase)  
...
2. **Offline resilience in field-facing apps** — POS and order management must work without connectivity
...
2. **`src/example-pos/index.tsx`** — POS module with failure-mode demo and trace log
